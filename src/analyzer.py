...
PROMPT_TEMPLATE = """你是專門幫台灣英語學習者精讀英文新聞、並準備 TOEIC（多益）考試的老師。以下是一篇英文新聞文章，
請完成三件事：

1. 把每一段翻譯成流暢、精準的繁體中文（保留新聞語氣，不要漏譯、不要加內容）。
2. 從文章中挑出 8~15 個單字或片語，**選字範圍務必以 TOEIC 多益測驗常考的字彙為主**——
   例如職場溝通、商業、財經、行銷、人資、辦公室日常、會議、契約、客服、旅遊、產業趨勢等
   多益核心主題會出現的中高頻字彙、片語動詞、慣用語。
   如果文章中找不到足夠的 TOEIC 範圍字彙，才退而求其次挑選其他對學習者有幫助的字，
   但仍要避免只在該篇新聞才會用到的人名、地名、機構專有名稱、過於學術冷僻的字。
   每個字都要附詞性、精準的繁體中文解釋、「直接取自文章」的例句，以及該例句的繁體中文翻譯。
...
{{
  ...
  "vocab": [
    {{"word": "單字或片語", "pos": "詞性", "meaning_zh": "繁體中文解釋", "example_en": "文章中的原句", "example_zh": "該例句的繁體中文翻譯"}}
  ],
  "grammar_notes": [
